...
vs, f = wavefront.ellipsoid_mesh(0.5, 0.5, 0.5, density=20, subdivisions=0)
...
nv_spherical, nf = wavefront.spherical_incremental_mesh_update(pt_spherical, v_spherical, f, surf_area=0.1, factor=1, radius_factor=1)

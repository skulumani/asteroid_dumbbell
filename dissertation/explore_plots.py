...
def plot_uncertainty(filename, img_path="/tmp/diss_explore"):
...
def plot_volume(filename, img_path="/tmp/diss_explore"):
...
if __name__ == "__main__":
    ...
    group.add_argument("-s", "--state", help="State trajectory plot",
                       action="store_true")
    group.add_argument("-m", "--magnification", help="Magnification for images",
    ...
    if args.reconstruct:
        exploration_generate_plots(args.hdf5_file, args.img_path, magnification=args.magnification);
    elif args.uncertainty:
        plot_uncertainty(args.hdf5_file, img_path=args.img_path)
    elif args.state:
        plot_state_trajectory(args.hdf5_file)
    elif args.volume:
        plot_volume(args.hdf5_file, img_path=args.img_path)

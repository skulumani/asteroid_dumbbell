...
class TestAsteroidItokawaOBJ():
    ...
    U_true = 2.7982574351445639e-09
    Ug_true = np.array([ -1.07220933e-09,   3.56120467e-11,  -4.58842528e-10])
    Ug_mat_true = np.array([[  5.59765880e-09,   1.95010629e-09,  -5.21360352e-10],                
                        [  1.95010629e-09,  -1.97221500e-09,   4.03422263e-10],                
                        [ -5.21360352e-10,   4.03422263e-10,  -3.62544380e-09]])
    ...
    for ii in range(normal_face.shape[0]):
        F_face_loop[:, :, ii] = np.outer(normal_face[ii, :], normal_face[ii, :])

...
/*     /1* HDF5::DataSet hf_dataset(hf_file_ptr.get(), "matrix", mat); *1/ */
/*     /1* HDF5::DataSet hf_dataset = hf_file_ptr->write_dataset("matrix", mat); *1/ */
/*     HDF5::DataSet hf_dataset(); */
/*     /1* save(*(hf_file_ptr->file_ptr), "matrix", mat); *1/ */
/* } */
...
/*     // close the file by reset */
/*     hf_file_ptr.reset(new HDF5::File("/tmp/test.hdf5", HDF5::File::ReadOnly)); */
/*     /1* hf_group_ptr.reset(new HDF5::Group(hf_file_ptr.get(), "group")); *1/ */

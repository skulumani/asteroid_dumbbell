...
int main(int argc, char* argv[]) {
    ...
    if (!input_file.empty()) {
        ...
        Mesh mesh_eigen(cube.vertices, cube.faces);
        Mesh mesh_string(input_file);
    
        std::cout << "V from mesh: \n" << mesh_string.vertices << std::endl;
        std::cout << "F from mesh: \n" << mesh_string.faces << std::endl;

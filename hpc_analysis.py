...
with np.load('data/castalia_1024_1e6.npz', allow_pickle=True) as data:
    ...
    np.savez('data/castalia_1024_1e6_energy_added.npz',ast_name=ast_name,num_faces=num_faces,time=time,state=state,KE=KE,PE=PE)
